...
public class RxClientCalls {
  ...
  public static <ReqT, RespT> Single<RespT> unaryCall(
      ClientCall<ReqT, RespT> clientCall, Single<ReqT> requestSingle) {
    return requestSingle.flatMap(request -> unaryCall(clientCall, request));
  }

  private static <ReqT, RespT> Single<RespT> unaryCall(ClientCall<ReqT, RespT> clientCall,
                                                         ReqT request) {
  ...
  public static <ReqT, RespT> Flowable<RespT> serverStreamingCall(
      ClientCall<ReqT, RespT> clientCall, Single<ReqT> requestSingle) {
    return requestSingle.flatMapPublisher(request -> serverStreamingCall(clientCall, request));
  }

  private static <ReqT, RespT> Flowable<RespT> serverStreamingCall(
