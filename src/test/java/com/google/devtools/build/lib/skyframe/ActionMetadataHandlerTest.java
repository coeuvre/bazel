...
public class ActionMetadataHandlerTest {
  ...
  public void resettingOutputs() throws Exception {
    ...
    handler.injectRemoteFile(artifact, new byte[] {1, 2, 3}, 42, 0, false);
  ...
  public void injectRemoteArtifactMetadata() throws Exception {
    ...
    int size = 10;
    handler.injectRemoteFile(artifact, digest, size, /* locationIndex= */ 1, false);
  ...
  public void injectRemoteTreeArtifactMetadata() throws Exception {
    ...
    RemoteFileArtifactValue fooValue = new RemoteFileArtifactValue(new byte[] {1, 2, 3}, 5, 1, false);
    RemoteFileArtifactValue barValue = new RemoteFileArtifactValue(new byte[] {4, 5, 6}, 10, 1, false);
