#ifndef BAZEL_SRC_TOOLS_REMOTE_SRC_MAIN_CPP_OUTPUT_SERVICE_COPY_H_
#define BAZEL_SRC_TOOLS_REMOTE_SRC_MAIN_CPP_OUTPUT_SERVICE_COPY_H_

#include <string>

#include "src/main/protobuf/remote_output_service.grpc.pb.h"

class CopyRemoteOutputService final
    : public remote_output_service::RemoteOutputService::Service {
public:
  CopyRemoteOutputService(std::string disk_cache) : disk_cache_(disk_cache) {}
...
#endif // BAZEL_SRC_TOOLS_REMOTE_SRC_MAIN_CPP_OUTPUT_SERVICE_COPY_H_