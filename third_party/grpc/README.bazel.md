...
2. `git checkout <tag>` (current is `v1.43.0`, commithash `b0f37a22bbae12a4b225a88be6d18d5e41dce881`)
...
5. In the `third_party/grpc` directory, apply local patches:
   `patch -p3 < bazel_1.43.0.patch`

# How to update the Java plugin:

1. Checkout tag `v1.43.2` from https://github.com/grpc/grpc-java
2. `cp -R <grpc-java git tree>/compiler/src/java_plugin third_party/grpc/compiler/src`

# How to update the Java code:

Download the necessary jars at version `1.43.2` from maven central.
